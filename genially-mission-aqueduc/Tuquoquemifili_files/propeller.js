...
//        if ('ontouchstart' in document.documentElement) {
            ...
            this.element.addEventListener('MSPointerDown', this.onRotationStart.bind(this));
            this.element.addEventListener('MSPointerMove', this.onRotated.bind(this));
            this.element.addEventListener('MSPointerUp', this.onRotationStop.bind(this));
            this.element.addEventListener('MSPointerCancel', this.onRotationStop.bind(this));
            this.element.addEventListener('dragstart', this.returnFalse);
            // IE 11+ Touch Screen
            this.element.style.touchAction = "none";
            this.element.addEventListener('pointerdown', this.onRotationStart.bind(this));
            this.element.addEventListener('pointermove', this.onRotated.bind(this));
            this.element.addEventListener('pointerup', this.onRotationStop.bind(this));
            this.element.addEventListener('pointercancel', this.onRotationStop.bind(this));
            this.element.addEventListener('dragstart', this.returnFalse);
//        } else {
			// Mouse
